package com.example.progaleria.registrarse.Model;

import com.example.progaleria.registrarse.Presenter.ListenerRegistrarse;
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            listenerRegistrarse.onError("Email ya se encuentra en uso");
                        }
